...
//                 <span className='text-green'>SuKriti</span> <span className='text-white'>Verma</span>
//             </h3>
...
//                 <p className='my-2'> suk@gmail.com</p>
//                 <p className='my-2'>9837429847</p>
//             </div>
//             {/* Email button */}
//             <button className='w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400 focus:outline-none' onClick={() => window.open('mailto:suk@gmail.com')}>Email me</button>
