...
//       <h5 className='my-3 font-m edium'>
//         I have completed my graduation by BCA from Magadh University.
//         I am fresher in web development .
//       </h5>
//       <div className='flex-grow p-4 mt-5 bg-gray-400 dark:bg-dark-500 shadow-custom-light dark:shadow-custom-dark' style={{ marginLeft: '-1.5rem', marginRight: '-1.5rem' }} >
//         <h6 className='my-3 text-xl font-bold tracking-wide'>What I offer</h6>
//         <div className='grid gap-6 lg:grid-cols-2'>

//             {services.map(service => (
//               <div className='bg-gray-200 rounded-lg lg-col-span-1 dark:bg-dark-200'key={Date()}>
